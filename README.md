...
| **复习题** | 逐题作答、自动批改、逐题解析；题型按客观/主观；填空题空位自动补齐（兼容 `___` 与 `【】`）；**极速刷题**整页下滑作答、**去AI**隐藏 AI 生成题、**错题本 + 一键导出错题 HTML**、键盘 ←/→/Enter 切题；掌握度报告 | [![复习题预览](showcase/preview/quiz-thumb.png)](showcase/preview/quiz.png) |
